...
public class DimensionWastelandTeleporter extends Teleporter
{
	...
	public DimensionWastelandTeleporter(WorldServer par1WorldServer)
	{
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			for (k1 = l - short1; k1 <= l + short1; ++k1)
			{
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
				{
					...
					{
						/** change this block **/
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == Fallout.portalWateland.blockID)
						{
							/** change this block **/
							while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Fallout.portalWateland.blockID)
							{
								--i2;
							}
		...
		if (d3 >= 0.0D)
		{
			if (flag)
			{
				this.destinationCoordinateCache.add(j1, new DimensionWastelandPortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
			...
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == Fallout.portalWateland.blockID)
			{
				j2 = 2;
			}
			/** change this block **/
			...
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == Fallout.portalWateland.blockID)
			{
				j2 = 3;
			}
			/** change this block **/
		...
		for (k2 = 0; k2 < 4; ++k2)
		{
			for (i3 = 0; i3 < 4; ++i3)
			{
				for (l2 = -1; l2 < 4; ++l2)
				{
					...
					/** change these blocks **/
					this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.blockDiamond.blockID : Fallout.portalWateland.blockID, 0, 2);
				}
			}
			for (i3 = 0; i3 < 4; ++i3)
			{
