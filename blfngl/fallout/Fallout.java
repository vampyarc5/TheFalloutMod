...
public class Fallout
{
	...
	//	public static final Item BotE = new WeapBotE(517, BOTE).setUnlocalizedName("BotE");
	//	public static final Item BumperSword = new WeapBotE(518, EnumToolMaterial.EMERALD).setUnlocalizedName("BumperSword");
	//	public static final Item Cleaver = new BaseMelee(519, 3, 1, 995, 1, 1).setUnlocalizedName("Cleaver");
	//	public static final Item ComKnife = new BaseMelee(520, 3, 1, 995, 1, 1).setUnlocalizedName("ComKnife");
	//	public static final Item CosKnife = new BaseMelee(521, 6, 1, 995, 1, 1).setUnlocalizedName("CosKnife");
	//	public static final Item CosClean = new BaseMelee(522, 7, 1, 995, 1, 1).setUnlocalizedName("CosClean");
	//	public static final Item CosFire = new WeapCosFire(523).setUnlocalizedName("CosFire");
	//	public static final Item FireAxe = new BaseMelee(524, 6, -1, 995, 1, 1).setUnlocalizedName("FireAxe");
	//	public static final Item Knife = new BaseMelee(525, 5, 2, 995, 1, 1).setUnlocalizedName("Knife");
	//	public static final Item Machete = new BaseMelee(526, 6, 0, 995, 1, 1).setUnlocalizedName("Machete");
	//	public static final Item Shishkebab = new WeapShishkebab(527, EnumToolMaterial.IRON).setUnlocalizedName("Shishkebab");
	//	public static final Item StraightRazor = new BaseMelee(528, 1, 1, 995, 1, 1).setUnlocalizedName("StraightRazor");
	//	public static final Item Switchblade = new BaseMelee(529, 2, 1, 995, 1, 1).setUnlocalizedName("Switchblade");
	//	public static final Item PintSizedKnife = new BaseMelee(530, 99999, 1, 995, 1, 1).setUnlocalizedName("PintSizedKnife");
	//
	//	public static final Item BallisticFist = new WeapBallisticFist(531, EnumToolMaterial.EMERALD).setUnlocalizedName("BallisticFist");
	//	public static final Item BladedGauntlet = new BaseMelee(532, 6, -1, 995, 1, 1).setUnlocalizedName("BladedGauntlet");
	//	public static final Item BoxingGloves = new BaseMelee(533, 1, 1, 995, 1, 1).setUnlocalizedName("BoxingGloves");
	//	public static final Item BrassKnuckles = new BaseMelee(534, 3, 1, 995, 1, 1).setUnlocalizedName("BrassKnuckles");
	//	public static final Item DisplacerGlove = new WeapDisplacerGlove(535, PFIST).setUnlocalizedName("DisplacerGlove");
	//	public static final Item GoldenGloves = new BaseMelee(536, 2, 1, 995, 1, 1).setUnlocalizedName("GoldenGloves");
	//	public static final Item PowerFist = new WeapPowerFist(537, EnumToolMaterial.EMERALD).setUnlocalizedName("PowerFist");
	//	public static final Item SatFist = new WeapPowerFist(538, EnumToolMaterial.EMERALD).setUnlocalizedName("SatFist");
	//	public static final Item SatHeatFist = new WeapSatHeatFist(539, PFIST).setUnlocalizedName("SatHeatFist");
	//	public static final Item SciGlove = new WeapSciGlove(540, SCI).setUnlocalizedName("SciGlove");
	//	public static final Item ZapGlove = new WeapZapGlove(541, EnumToolMaterial.IRON).setUnlocalizedName("ZapGlove");
	...
	public static final Item rifleRailway = new ItemGun(742, 8, 8, 2.7, 3, "blfngl.RailwayFire", "Blfngl.RailwayReload", railwaySpikes, 224).setUnlocalizedName("RailwayRifle").setCreativeTab(TabFalloutRifle);
	public static final Item rifleXuanlong = new ItemGun(743, 7, 36, 2.2, 0.5, "blfngl.ChineseAssaultFire", "Blfngl.ChineseAssaultReload", a556, 1111).setUnlocalizedName("Xuanlong").setCreativeTab(TabFalloutRifle);
