...
public class EntityFragTimed extends Entity
{
    /** How long the fuse is */
    public int fuse;

    public EntityFragTimed(World par1World)
    {
        super(par1World);
        this.fuse = 0;
    ...
    public EntityFragTimed(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
